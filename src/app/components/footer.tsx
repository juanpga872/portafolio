      ...
      <div className="container mx-auto px-24">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://github.com/juanpga872" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
            ...
            <a href="https://www.linkedin.com/in/juan-pablo-garc%C3%A9s-20b43123b/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
